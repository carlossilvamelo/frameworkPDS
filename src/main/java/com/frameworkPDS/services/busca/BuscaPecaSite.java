...
public class BuscaPecaSite implements Busca{

	
	private Document documento;
	private List<Peca> pecas = new ArrayList<Peca>();;
	
	public BuscaPecaSite(String url){
	...
	public List<Peca> buscarPeca(String idValor, String idProduto) throws HttpStatusException{
		...
		//Collections.sort(pecas, comparator);
		
		//pecas.forEach((v->{System.out.println(v);}));
		menorPreco(pecas);
		maisAvaliado();
		return pecas;//menorPreco(pecas);
	}
	
	
	public List<Peca> maisAvaliado(){
